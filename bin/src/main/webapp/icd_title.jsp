...
<header id="top">
	...
	<div id="subject">
		<div class="wrapper row">
			<div class="col-xs-2" id="logo">
				<a href="${path}/index"><img src="${path }/images/logo-zx.png"
					style="width: 160px;" /></a>
			</div>
	...
	<nav class="navbar navbar-inverse">
		<div class="wrapper row">
			<div class="navbar-header categories col-xs-3">
				<div id="title">
				...
				<div id="menu">
					<ul class="cate-list">
						...
						<c:forEach var="ParentCategory" items="${categoryList}">
							<li>
								<a href="${path}/productList/ParentCategory/${ParentCategory.id}/1" class="text-ellipsis">${ParentCategory.name}<i id="director" class="icon-angle-right"></i></a>
								<ul class="sub-list">
									<c:forEach var="sonCategory" items="${ParentCategory.childElement}">
			...
			<ul class="nav navbar-nav col-xs-9">
				<li class="active"><a href="${path}/index" target="_self">首页</a></li>
